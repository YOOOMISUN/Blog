	...
	<div class="col-sm-10">
			...
			<br>
				...
				%>
					<tr>
						<td>Diary Date</td>
						<td><a><%=rs.getString("diary_date")%></a></td>
					</tr>
					<tr>
						<td>Diary Todo</td>
						<td><%=rs.getString("diary_todo")%></td>
					</tr>
					<tr>
						<td>Create Date</td>
			...
			<div style="text-align :right">
				...
				<a href="./updateDiaryForm.jsp?diaryNo=<%=diaryNo%>" class="btn btn-info">수정</a>
				<a href="./deleteDiaryAction.jsp?diaryNo=<%=diaryNo%>" class="btn btn-info">삭제</a>
			</div>
		</div>
	</div>
</div>
